// =============================================================================
// Core Questions Module - Human question queue and interjections
// =============================================================================
...
// =============================================================================
// Context - tasksFile path (set by CLI)
// =============================================================================

let tasksFilePath = join(process.cwd(), "tasks.yaml");

export function setTasksFilePath(path: string): void {
  tasksFilePath = path;
}
...
function getQueueDir(): string {
  return join(dirname(tasksFilePath), ".questions");
}

function getInterjectDir(): string {
  return join(dirname(tasksFilePath), ".interjections");
}
...
function getTriggerDir(): string {
  return join(dirname(tasksFilePath), ".interjections", "triggers");
}
